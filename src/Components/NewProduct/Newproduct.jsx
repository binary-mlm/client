...
const Newproduct = () => {
  ...
  return (
    ...
    <div className="row align-items-center mb-3 mt-3">
        <h4 className="col-6 fw-bold">New Products</h4>
        <div className="col-6 text-end">
          <a href="/allproduct" className="fw-bold text-decoration-none text-dark">
            <span className="text-success">See all products</span>
